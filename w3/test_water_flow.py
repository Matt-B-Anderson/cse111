...
def test_pressure_loss_from_fittings():
    assert water_flow.pressure_loss_from_fittings(0.00, 3) == approx(0.00, abs=0.001)
    assert water_flow.pressure_loss_from_fittings(1.65, 0) == approx(0.00, abs=0.001)
...
def test_pressure_loss_from_pipe_reduction():
    assert water_flow.pressure_loss_from_pipe_reduction(0.28687, 0.000003498, 0.048692) == approx(0.000, abs=0.001)
    assert water_flow.pressure_loss_from_pipe_reduction(0.28687, 1.65, 0.048692) == approx(-163.744, abs=0.001)
    assert water_flow.pressure_loss_from_pipe_reduction(0.28687, 1.75, 0.048692) == approx(-184.182, abs=0.001)
